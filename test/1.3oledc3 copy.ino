...
void drawLogoWithLoadingBar(unsigned long currentTime) {
    ...
    for (int y = 0; y < 64; y++) {
        for (int x = 0; x < 64; x++) {
            ...
            myOLED.drawPixel(32 + x, y, pixel ? SH110X_WHITE : SH110X_BLACK);
        }
    }
    ...
    myfont.print(0, 50, "loading...", SH110X_WHITE, SH110X_BLACK);
    myOLED.fillRect(0, 60, barWidth, 4, SH110X_WHITE);
    myOLED.display();
}
// **Hàm chính**
void setup() {
