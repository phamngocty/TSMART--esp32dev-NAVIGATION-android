...
void displayNavigation() {
    if (app.navDisplayMode == 1) {
        ...
        // Kiểu hiển thị "map2"
         ...
         if (watch.getNavigation().hasIcon && watch.getNavigation().active) {
             myOLED.drawBitmap(50+20, 0, watch.getNavigation().icon, 48, 48, SSD1306_WHITE);
         }
         ...
         float meters = convertToMeters(app.navTitle);
         float mappedValue = constrain(map(meters, 0, 500, 0, 50), 0, 50);
         myOLED.drawRect(100+20, 0, 8, 51, SSD1306_WHITE);
         myOLED.fillRect(101+20, 1, 6, 50, SSD1306_BLACK);
         myOLED.fillRect(100+20, mappedValue, 8, 51 - mappedValue, SSD1306_WHITE);
